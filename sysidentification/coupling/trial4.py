...
df7 = pd.read_excel(os.getcwd() + '/sysidentification/data/male_IRD_redo.xlsx')
...
male_active2 = df7.iloc[123:123+9, start:start + N]
male_active2 = male_active2.to_numpy()
male_recovered2 = df7.iloc[135:135+9, start:start + N]
