...
df1 = pd.read_excel(os.getcwd() + '/simulation_results/coupling/solution_casadi379N37.xlsx', 'Sheet1')
df2 = pd.read_excel(os.getcwd() + '/simulation_results/coupling/solution_casadi379N37.xlsx', 'Sheet2', index_col=None)
df3 = pd.read_excel(os.getcwd() + '/simulation_results/coupling/solution_casadi379N37.xlsx', 'Sheet3', index_col=None)

bounds = df3.iloc[0:20,0:37]
