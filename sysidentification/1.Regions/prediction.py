...
print(one_sample)
x_traj = symbol("x_traj_age", nx, M)
beta_time_var = symbol("beta_time_var", nu * (M-1), 1)
...
model_mismatch = data.T - y_sym[:,0:np.shape(data.T)[1]]
...
alpha_reg = 1e8
alpha_reg_vec = np.ones((M-2)) * alpha_reg
...
alpha_reg = 1e6
alpha_reg_vec = np.ones((M-2)) * alpha_reg
alpha_reg_vec[43 - 13:53 - 13] = 1e5
alpha_reg_vec[61 - 13:71 - 13] = 1e5
alpha_reg_vec[105 - 13:115 - 13] = 1e5
alpha_reg_vec[217 - 13:227 - 13] = 1e5
alpha_reg_vec[256 - 13:266 - 13] = 1e5
alpha_reg_vec[267 - 13:277 - 13] = 1e5
alpha_reg_vec[278 - 13:288 - 13] = 1e5
...
# alpha_reg_vec[288 - 13:290 - 13] = 1e4
# alpha_reg_vec[293 - 13:298 - 13] = 1e4
